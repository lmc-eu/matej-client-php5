...
class RequestTest extends UnitTestCase
{
    ...
    /** @test */
    public function shouldStoreCustomRequestId()
    {
    ...
    /** @test */
    public function shouldStoreResponseClass()
    {
        $request = new Request('/foo', RequestMethodInterface::METHOD_GET, [], null, SortingResponse::class);
        $this->assertSame(SortingResponse::class, $request->getResponseClass());
    }

    /** @test */
    public function shouldThrowExceptionWhenSettingInvalidResponseClass()
    {
