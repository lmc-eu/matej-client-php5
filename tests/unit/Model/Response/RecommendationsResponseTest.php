...
class RecommendationsResponseTest extends UnitTestCase
{
    ...
    {
        $interactionCommandResponse = (object) ['status' => CommandResponse::STATUS_OK, 'message' => 'MOCK_INTERACTION_MESSAGE', 'data' => ['MOCK' => 'INTERACTION']];
        $userMergeCommandResponse = (object) ['status' => CommandResponse::STATUS_OK, 'message' => 'MOCK_USER_MERGE_MESSAGE', 'data' => ['MOCK' => 'USER_MERGE']];
        $recommendationCommandResponse = (object) ['status' => CommandResponse::STATUS_OK, 'message' => 'MOCK_RECOMMENDATION_MESSAGE', 'data' => ['MOCK' => 'RECOMMENDATION']];
