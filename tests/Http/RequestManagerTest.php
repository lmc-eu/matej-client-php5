...
class RequestManagerTest extends TestCase
{
     ...
     * @test
     */
    public function shouldSendAndDecodeRequest()
    {
        ...
        $this->assertRegExp('~https\\://account\\-id\\.matej\\.lmc\\.cz/foo/endpoint\\?hmac_timestamp\\=[0-9]+&hmac_sign\\=[[:alnum:]]~', $recordedRequests[0]->getUri()->__toString());
        ...
        $this->assertSame('php-client/' . Matej::VERSION, $recordedRequests[0]->getHeader(RequestManager::CLIENT_VERSION_HEADER)[0]);
    }
}
