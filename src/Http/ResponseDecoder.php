...
class ResponseDecoder implements ResponseDecoderInterface
{
    public function decode(ResponseInterface $httpResponse)
    {
        ...
        return new Response((int) $responseData->commands->number_of_commands, (int) $responseData->commands->number_of_successful_commands, (int) $responseData->commands->number_of_failed_commands, $responseData->commands->responses);
    }
}
