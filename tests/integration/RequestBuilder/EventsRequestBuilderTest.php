...
class EventsRequestBuilderTest extends IntegrationTestCase
{
    ...
    {
        $response = static::createMatejInstance()->request()->events()->addInteraction(Interaction::withItem('search', 'user-a', 'item-a'))->addInteractions([Interaction::withItem('detailview', 'user-b', 'item-a'), Interaction::withItem('purchase', 'user-d', 'item-a')])->addUserMerge(UserMerge::mergeInto('user-a', 'user-b'))->addUserMerges([UserMerge::mergeInto('user-a', 'user-c'), UserMerge::mergeInto('user-a', 'user-d')])->addItemProperty(ItemProperty::create('item-a', ['test_property_a' => 'test-value-a']))->addItemProperties([ItemProperty::create('item-a', ['test_property_b' => 'test-value-b']), ItemProperty::create('item-a', ['test_property_c' => 'test-value-c'])])->send();
